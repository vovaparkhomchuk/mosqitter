...
const info = [
  { text: 'Privacy Policy', style: 'headerr' },
  ...
  {
    text: `For the purposes of this Privacy Policy:<br />
  ...
  •	Website refers to Mosqitter.com/, accessible from http://mosqitter.com/<br />
  ...
  { text: 'Collecting and Using Your Personal Data', style: 'small-header' },
  { text: `Personal Data`, style: 'small-header' },
  {
    text: `While using Our Service, We may ask You to provide Us with certain personally identifiable information that can be used to contact or identify You. Personally identifiable information may include, but is not limited to:<br />
  •	Email address<br />
  ...
  { text: `Usage Data`, style: 'small-header' },
  {
    text: `Usage Data is collected automatically when using the Service.<br />
  ...
  {
    text: `The Company allows You to create an account and log in to use the Service through the following Third-party Social Media Services:<br />
  •	Google<br />
  •	Facebook<br />
  •	Twitter<br /><br />
  ...
  { text: 'Tracking Technologies and Cookies', style: 'small-header' },
  {
    text: `
    ...
    Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. You can learn more about cookies here: All About Cookies by TermsFeed.<br />
  ...
  { text: `Use of Your Personal Data`, style: 'small-header' },
  {
  ...
  { text: `Retention of Your Personal Data`, style: 'small-header' },
  {
  ...
  { text: `Transfer of Your Personal Data`, style: 'small-header' },
  {
  ...
  { text: `Disclosure of Your Personal Data`, style: 'med-header' },
  { text: `Business Transactions`, style: 'small-header' },
  {
  ...
  { text: `Law enforcement`, style: 'small-header' },
  {
  ...
  {
    text: `The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:<br />
  ...
  { text: `Links to Other Websites`, style: 'small-header' },
  {
  ...
  {
    text: `<div>If you have any questions about this Privacy Policy, You can contact us:
