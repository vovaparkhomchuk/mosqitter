...
const info = [
  { text: 'Terms and Conditions', style: 'headerr' },
  { text: 'Last updated: July 16, 2021', style: 'small-header' },
  {
    text: 'Please read these terms and conditions carefully before using Our Service.',
    style: 'simple-text'
  },
  { text: 'Interpretation and Definitions', style: 'med-header' },
  { text: 'Interpretation', style: 'small-header' },
  {
  ...
  { text: `Definitions`, style: 'small-header' },
  {
    text: `For the purposes of these Terms and Conditions:<br /><br />
    ...
    •	Country refers to: Ukraine<br />
    •	Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Mosquito Control LLC, 13 Kharkivske shosse str., Poltava, 36008, Ukraine.<br />
    ...
    •	Website refers to Mosqitter, accessible from http://mosqitter.com/<br />
    •	You means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.
    `,
    style: 'simple-text'
  },
  { text: 'Acknowledgment', style: 'small-header' },
  {
  ...
  {
    text: `Our Service may contain links to third-party web sites or services that are not owned or controlled by the Company.<br />
  ...
  { text: 'Limitation of Liability', style: 'small-header' },
  {
  ...
  { text: `"AS IS" and "AS AVAILABLE" Disclaimer`, style: 'small-header' },
  {
  ...
  { text: `Governing Law`, style: 'small-header' },
  {
  ...
  { text: `Changes to These Terms and Conditions`, style: 'small-header' },
  {
  ...
  {
    text: `If you have any questions about these Terms and Conditions, You can contact us:<br />
    •	By email: office@mosqitter.com    
  `,
    style: 'simple-text'
  }
];
